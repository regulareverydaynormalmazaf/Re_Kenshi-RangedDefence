...
- **External build dependencies (not included in this repo):**
  ...
  - **`mod_hub_api.h`** — the [Emkejs‑Mod‑Core](https://github.com/Emkej/Emkejs-Mod-Core/tree/main/include/emc) SDK header, and place `mod_hub_api.h` in `RangedDefence/` next to `RangedDefence.cpp` before building.
